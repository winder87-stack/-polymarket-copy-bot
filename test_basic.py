...
class MockTradeExecutor:
    def __init__(self):
        ...
        self.settings = type('obj', (object,), {'risk': type('obj', (object,), {'max_daily_loss': 100.0})()})()
...
assert 'Daily loss limit reached' in executor.circuit_breaker_reason, 'Reason should be set correctly'
