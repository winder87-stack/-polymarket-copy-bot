    ...
    async def test_performance_validation(self) -> Dict[str, Any]:
        ...
        try:
            ...
            with patch('core.wallet_monitor.Web3'), \
                ...
                await wallet_monitor.get_wallet_transactions("0x742d35Cc6634C0532925a3b844Bc454e4438f44e")
                ...
                if second_call_time < first_call_time * 0.1:  # 10x faster
                    ...
                    results['details'].append(f"⚠️ Cache performance suboptimal: {second_call_time:.3f}s vs {first_call_time:.3f}s")
