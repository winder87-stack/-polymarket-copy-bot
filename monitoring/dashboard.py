...
class MonitoringDashboard:
    ...
    async def _get_security_overview(self) -> Dict[str, Any]:
        ...
        overview = {"latest_scan": {}, "trends": {}, "critical_issues": []}
    ...
    async def _get_performance_metrics(self) -> Dict[str, Any]:
        ...
        metrics = {"latest_benchmark": {}, "regressions": [], "improvements": []}
    ...
    async def _get_alert_health(self) -> Dict[str, Any]:
        ...
        health = {"latest_check": {}, "health_trend": [], "issues": []}
    ...
    async def _get_trends_analysis(self) -> Dict[str, Any]:
        ...
        if recent_runs:
            ...
            if len(recent_runs) >= 2:
                ...
                if latest_security.get("critical_issues", 0) > prev_security.get(
                    "critical_issues", 0
                ):
                    trends["security_trend"] = "worsening"
                    trends["insights"].append("Security issues are increasing")
                elif latest_security.get("critical_issues", 0) < prev_security.get(
                    "critical_issues", 0
                ):
