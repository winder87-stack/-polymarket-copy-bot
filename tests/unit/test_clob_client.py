...
class TestPolymarketClientMarketOperations:
    ...
    async def test_get_market_success(
        self, mock_polymarket_client, mock_clob_client, sample_market_data
    ):
    ...
    async def test_get_market_cached(
        self, mock_polymarket_client, mock_clob_client, sample_market_data
    ):
    ...
    async def test_get_market_cache_expiry(
        self, mock_polymarket_client, mock_clob_client, sample_market_data
    ):
...
class TestPolymarketClientOrderOperations:
    ...
    async def test_place_order_success(
        self, mock_polymarket_client, mock_clob_client, mock_web3, sample_trade
    ):
    ...
    async def test_place_order_contract_logic_error(
        self, mock_polymarket_client, mock_clob_client, sample_trade
    ):
    ...
    async def test_place_order_with_slippage_buy(
        self, mock_polymarket_client, mock_clob_client, mock_web3, sample_trade
    ):
        ...
        await mock_polymarket_client.place_order(
            condition_id=sample_trade["condition_id"],
            side="BUY",
            amount=sample_trade["amount"],
            price=0.65,
    ...
    async def test_place_order_with_slippage_sell(
        self, mock_polymarket_client, mock_clob_client, mock_web3, sample_trade
    ):
...
class TestPolymarketClientOrderBookOperations:
    ...
    async def test_get_order_book_success(
        self, mock_polymarket_client, mock_clob_client, sample_order_book
    ):
...
class TestPolymarketClientHealthCheck:
    ...
    async def test_health_check_high_gas_price(
        self, mock_polymarket_client, mock_clob_client, mock_web3
    ):
...
class TestPolymarketClientIntegration:
    ...
    async def test_balance_and_health_check_flow(
        self, mock_polymarket_client, mock_clob_client, mock_web3
    ):
        ...
        # Verify calls
        assert (
            mock_clob_client.get_balance.call_count == 2
        )  # Once for balance, once for health check
