...
class TestWalletMonitorTransactionFetching:
    ...
    async def test_get_wallet_transactions_with_api_key(
        ...
        transactions = await mock_wallet_monitor.get_wallet_transactions(
            "0x742d35Cc6634C0532925a3b844Bc454e4438f44e", 49900000, 50000000
        )
    ...
    async def test_get_wallet_transactions_api_failure(
        ...
        mock_response.json = AsyncMock(
            return_value={"status": "0", "message": "Error", "result": []}
        )
    ...
    async def test_get_basic_transactions_success(
        self, mock_wallet_monitor, mock_web3, sample_transaction
    ):
...
class TestWalletMonitorTradeDetection:
    ...
    def test_detect_polymarket_trades_already_processed(
        self, mock_wallet_monitor, sample_transaction
    ):
    ...
    def test_detect_polymarket_trades_non_polymarket_contract(
        self, mock_wallet_monitor, sample_transaction
    ):
    ...
    def test_detect_polymarket_trades_recent_transaction(
        self, mock_wallet_monitor, sample_transaction
    ):
...
class TestWalletMonitorMainMonitoring:
    ...
    async def test_monitor_wallets_success(
        self,
        mock_wallet_monitor,
    ...
    async def test_monitor_wallets_with_detected_trades(
        self, mock_wallet_monitor, sample_transaction, sample_trade
    ):
...
class TestWalletMonitorCleanup:
    ...
    async def test_clean_processed_transactions(self, mock_wallet_monitor):
        ...
        recent_trade = {"tx_hash": recent_tx, "timestamp": now - timedelta(hours=1)}
...
class TestWalletMonitorHealthCheck:
    ...
    async def test_health_check_transaction_fetch_error(
        self, mock_wallet_monitor, mock_aiohttp_session
    ):
