...
class InsufficientBalanceError(TradingError):
    ...
    def __init__(self, required: str, available: str, currency: str = "USDC") -> None:
        ...
        super().__init__(
            message, {"required": required, "available": available, "currency": currency}
        )
...
class SlippageExceededError(TradingError):
    ...
    def __init__(self, expected_price: str, actual_price: str, max_slippage: str) -> None:
        """
...
class PositionLimitError(TradingError):
    ...
    def __init__(self, requested_size: str, max_size: str) -> None:
        ...
        super().__init__(message, {"requested_size": requested_size, "max_size": max_size})
